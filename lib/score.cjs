...
function evaluateCheck(parsed, options = {}) {
  ...
  const reason = tiboFails ? 'tibo_fail' : (concreteFails ? 'cutoff_concrete_date'
...
module.exports = { evaluateCheck, scoreTibo, scoreCutoff, scoreJuice, localDate, concreteCutoffMode, EVASIVE_HINT };
